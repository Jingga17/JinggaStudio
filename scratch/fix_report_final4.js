...
const idx1 = code.lastIndexOf('LAPORAN ANALISIS INDIVIDU');
const letIdx1 = code.lastIndexOf('let html =', idx1);
code = code.substring(0, letIdx1) + inject1 + '\\n      ' + code.substring(letIdx1);
...
const idx2 = code.lastIndexOf('LAPORAN ANALISIS KELAS<br>KELAS');
const letIdx2 = code.lastIndexOf('let html =', idx2);
code = code.substring(0, letIdx2) + inject2 + '\\n      ' + code.substring(letIdx2);

code = code.replace(/\\\\n/g, '\\n');
fs.writeFileSync('frontend/js/pages/report.js', code);
console.log('Fixed renderIndividuReal and renderKelasReal!');
